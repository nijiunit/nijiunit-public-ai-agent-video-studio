...
- Before displaying a still review image directly in the conversation, say what the photo is for and what to check. If the interface cannot attach it, open the image itself. Open HTML review pages and videos as the artifacts themselves. Never distinguish several folder images only as “this image,” “the right image,” or “the selected image,” and never claim something opened when it did not. For a workbook folder handoff, name the exact file and never rely on highlight color.
