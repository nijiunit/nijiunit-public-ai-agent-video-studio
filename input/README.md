...
Place the story and project-specific source material for your next local run in
this directory. The contents are ignored by Git so private references are not
published accidentally.

Recommended files:

- `story.md` or `story.txt`
