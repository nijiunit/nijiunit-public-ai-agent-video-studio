...
provider and laws applicable to their use.

Do not add a media asset to a publishable character profile unless
`source_type`, `asset_license`, and `publishable` are recorded and reviewed.
